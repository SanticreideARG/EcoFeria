...
/** Esqueleto del panel de vendedor (M5). El panel real es Sprint 2. */
  ...
  return (
    <div className="mx-auto max-w-[720px] px-5 py-10">
      <div className="mb-6 flex items-center gap-3">
        ...
        <h1 className="font-display text-display-lg-mobile text-primary">Panel de Vendedor</h1>
      </div>
      ...
      <p className="mt-4 text-body-sm text-on-surface-variant">
        Inventario, pedidos recibidos, mini-blog de marca y mensajería con clientes llegan en
        Sprint 2.
      </p>
      <button
        type="button"
